        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div>
            <input
              ...
              className={`w-full bg-transparent border-b-2 ${errors.email ? 'border-red-400' : 'border-white'} text-white placeholder-gray-200 focus:outline-none focus:border-blue-400 py-2 dark:text-white dark:placeholder-gray-300`}
            />
            {errors.email && (
