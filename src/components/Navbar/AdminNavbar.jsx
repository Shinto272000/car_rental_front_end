...
const AdminNavbar = () => {
  ...
  const navLinks = [
    { path: "/admin/dashbord", value: "Dashboard" },
    { path: "/adminssss/add-cars", value: "Add Car" },
    { path: "/admin/carlist", value: "Car List" },
    { path: "/admin/dealersList", value: "Dealers List" },
    { path: "/admin/allordersss", value: "All Orders" },
    { path: "/dealer/signup", value: "Sign Out" },
  ];
